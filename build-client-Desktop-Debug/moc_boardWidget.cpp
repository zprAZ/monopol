...
const QMetaObjectExtraData boardWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject boardWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_boardWidget,
      qt_meta_data_boardWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &boardWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_boardWidget))
